...
class StateMachineGenerator:
    ...
    def __generate_independent_state_machine(self, target_state=None):
        ...
        target_state = target_state if target_state else HierarchyState(sm_name)
        state_order_list = []
    ...
    def __clear_state(self,state):
        for child_state in state.states.values():
           state.remove_state(child_state.state_id, True, True, True)
    ...
    def __is_valid_target_state(self, target_state):
        ...
        if target_state is None:
            ...
            error_message = 'Can\'t plan into None.'
             ...
             is_valid = False
             error_message = "Can't Plan into State {}, can only plan into Hierarchystate!".format(target_state)
            ...
            if not permission or permission.lower() == 'true':
                is_valid = False
                error_message = "Can't plan into None empty Hierarchy State without permission!"
