...
def test_recursive_insert(root_type,type_to_insert,expected):
    #arrange
    sut = TypeTree(root_type)
    inserted = False
    #act
...
def test_add_type_branch(root_type,type_to_insert, other_type_in_branch, expected):
    #arrange
    sut = TypeTree(root_type)
    inserted = False
    #act
...
def test_is_in_tree(root_type,type_to_insert,type_to_look,expected):
    #prepare
    sut = TypeTree(root_type)
    isInTree = False
...
def test_get_as_string(root_type,to_insert,expected):
    #prepare
    sut = TypeTree(root_type)
    tree_as_string = ""
