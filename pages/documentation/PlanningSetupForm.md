...
It's the main window of the plugin. So it's the part where to start a new state machine generation process, configure a new Task, and get information about the current configuration.
